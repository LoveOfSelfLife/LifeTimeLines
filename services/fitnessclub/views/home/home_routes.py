...
from common.fitness.member_entity import get_member_id_from_user_context, get_member_detail_from_user_context
...
def reschedule_workout_modal(context=None):
    """Modal for rescheduling a workout"""
    ...
    try:
        ...
        return hx_render_template(
            ...
            <div class="alert alert-success">
              <i class="bi bi-check-circle me-2"></i>Workout rescheduled successfully!
            </div>
            <script>
              setTimeout(() => {
